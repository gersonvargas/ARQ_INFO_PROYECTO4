...
if (isset($_GET['metodo'])) {
    if ($_GET['metodo'] == 'buscar') {
        ...
        if ($valor_buscado !== '') {
            $clientes = PhoneCall::getPhoneCallsID($valor_buscado);
        } else {
            $clientes = PhoneCall::getPhoneCalls();
        }
    } else {
        $clientes = PhoneCall::getPhoneCalls();
    }
        ...
        <main class="container">
            ...
            <div class="">
                <table data-toggle="table" id="tableCustomers" class="table table-hover">
                    <thead>
                        <tr>
                            <th data-field="Id" data-sortable="true">Phone </br>Call ID</th>
                            <th data-field="Type" data-sortable="true">Phone </br>Number</th>
                            <th data-field="Name" data-sortable="true">Called </br>Type Code</th>
                            <th data-field="From" data-sortable="true">Number </br>Called</th>
                            <th data-field="To" data-sortable="true">Call Start</th>
                            <th data-field="end" data-sortable="true">Call End</th>
                            <th data-field="Detail" data-sortable="true">Details</th>
                            <th>Actions</th>
                    ...
                    <tbody>
                        ...
                        if (count($clientes) > 0) {
                            ...
                            foreach ($clientes as $value) {
                                ...
                                echo '<td>' . $value['NUMBER_CALLED_TYPE_CODE'] . "</td>";
                                echo '<td>' . $value['NUMBER_CALLED'] . "</td>";
                                echo '<td>' . $value['CALL_START_DATETIME'] . "</td>";
                                echo '<td>' . $value['CALL_END_DATETIME'] . "</td>";
                                echo '<td>' . $value['OTHER_DETAILS'] . "</td>";
                                echo '<td>'
                                . '<a class="btn btn-primary btn-sm" href="PhoneCallForm.php?PHONE_CALL_ID='
                                . $value['PHONE_CALL_ID'] . '">Edit</a>'
                                . '<b> | </b><a class="btn btn-danger btn-sm" href="Actions.php?PHONE_CALL_ID=' .
                                $value['PHONE_CALL_ID'] . '&metodo=delete">Delete</a> </td>';
                                echo '</tr>';
                            }
                        } else {
                            echo '<p class="alert alert-warning"> There are no phone calls! </p>';
                        }
                        ?>
                    </tbody>
                </table>
            ...
            <div class="row float-right mr-auto">
                ...
                <a href="PhoneCallForm.php" class="btn btn-success btn-sm">Add New</a>
            </div>
        </main>

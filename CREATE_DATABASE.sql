...
USE sql3265636;
DROP TABLE IF  EXISTS sql3265636.CUSTOMER_ADDRESSES;
DROP TABLE IF  EXISTS sql3265636.BILL_DETAIL_LINES;
DROP TABLE IF  EXISTS sql3265636.CUSTOMER_PHONE_CALLS;
DROP TABLE IF  EXISTS sql3265636.BILL_HEADERS;
DROP TABLE IF  EXISTS sql3265636.CUSTOMER_PHONE_NUMBERS;
DROP TABLE IF  EXISTS sql3265636.CUSTOMER;
DROP TABLE IF  EXISTS sql3265636.REF_ADDRESS_TYPE;
DROP TABLE IF  EXISTS sql3265636.ADDRESSES;
DROP TABLE IF  EXISTS sql3265636.TARIFFS;
DROP TABLE IF  EXISTS  sql3265636.REF_TARIFF_TYPES;
DROP TABLE IF  EXISTS sql3265636.REF_NUMBER_CALLED_TYPE;
DROP TABLE IF  EXISTS sql3265636.REF_CUSTOMER_NUMBER_TYPES;

CREATE TABLE IF NOT EXISTS  sql3265636.ADDRESSES(
...
CREATE TABLE IF NOT EXISTS  sql3265636.REF_TARIFF_TYPES (
   TARIFF_TYPE_CODE INT PRIMARY KEY,
   TARIFF_TYPE_DESCRIPTION VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;

CREATE TABLE IF NOT EXISTS sql3265636.REF_NUMBER_CALLED_TYPE (
   NUMBER_CALLED_TYPE_CODE INT PRIMARY KEY,
   NUMBER_CALLED_TYPE_DESC VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;

CREATE TABLE IF NOT EXISTS sql3265636.REF_CUSTOMER_NUMBER_TYPES (
   CUSTOMER_NUMBER_TYPE_CODE INT PRIMARY KEY,
   NUMBER_TYPE_DESCRIPTION VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;

CREATE TABLE IF NOT EXISTS  sql3265636.TARIFFS (
...
CREATE TABLE IF NOT EXISTS sql3265636.CUSTOMER (
...
CREATE TABLE IF NOT EXISTS sql3265636.REF_ADDRESS_TYPE (
   ADDRESS_TYPE_CODE INT PRIMARY KEY,
   ADDRESS_TYPE_DESCRIPTION VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;
CREATE TABLE IF NOT EXISTS sql3265636.CUSTOMER_PHONE_NUMBERS (
...
CREATE TABLE IF NOT EXISTS sql3265636.BILL_HEADERS (
...
CREATE TABLE IF NOT EXISTS sql3265636.CUSTOMER_PHONE_CALLS (
...
CREATE TABLE sql3265636.BILL_DETAIL_LINES (
...
CREATE TABLE IF NOT EXISTS sql3265636.CUSTOMER_ADDRESSES (

...
DROP DATABASE IF EXISTS id7841828_phonebill;
CREATE DATABASE IF NOT EXISTS id7841828_phonebill;
USE id7841828_phonebill;
DROP TABLE IF  EXISTS id7841828_phonebill.CUSTOMER_ADDRESSES;
DROP TABLE IF  EXISTS id7841828_phonebill.BILL_DETAIL_LINES;
DROP TABLE IF  EXISTS id7841828_phonebill.CUSTOMER_PHONE_CALLS;
DROP TABLE IF  EXISTS id7841828_phonebill.BILL_HEADERS;
DROP TABLE IF  EXISTS id7841828_phonebill.CUSTOMER_PHONE_NUMBERS;
DROP TABLE IF  EXISTS id7841828_phonebill.CUSTOMER;
DROP TABLE IF  EXISTS id7841828_phonebill.REF_ADDRESS_TYPE;
DROP TABLE IF  EXISTS id7841828_phonebill.ADDRESSES;
DROP TABLE IF  EXISTS id7841828_phonebill.TARIFFS;
DROP TABLE IF  EXISTS  id7841828_phonebill.REF_TARIFF_TYPES;
DROP TABLE IF  EXISTS id7841828_phonebill.REF_NUMBER_CALLED_TYPE;
DROP TABLE IF  EXISTS id7841828_phonebill.REF_CUSTOMER_NUMBER_TYPES;

CREATE TABLE IF NOT EXISTS  id7841828_phonebill.ADDRESSES(
...
CREATE TABLE IF NOT EXISTS  id7841828_phonebill.REF_TARIFF_TYPES (
   TARIFF_TYPE_CODE INT PRIMARY KEY,
   TARIFF_TYPE_DESCRIPTION VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;

CREATE TABLE IF NOT EXISTS id7841828_phonebill.REF_NUMBER_CALLED_TYPE (
   NUMBER_CALLED_TYPE_CODE INT PRIMARY KEY,
   NUMBER_CALLED_TYPE_DESC VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;

CREATE TABLE IF NOT EXISTS id7841828_phonebill.REF_CUSTOMER_NUMBER_TYPES (
   CUSTOMER_NUMBER_TYPE_CODE INT PRIMARY KEY,
   NUMBER_TYPE_DESCRIPTION VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;

CREATE TABLE IF NOT EXISTS  id7841828_phonebill.TARIFFS (
...
CREATE TABLE IF NOT EXISTS id7841828_phonebill.CUSTOMER (
...
CREATE TABLE IF NOT EXISTS id7841828_phonebill.REF_ADDRESS_TYPE (
   ADDRESS_TYPE_CODE INT PRIMARY KEY,
   ADDRESS_TYPE_DESCRIPTION VARCHAR(20)
) ENGINE = INNODB ROW_FORMAT = DEFAULT;
CREATE TABLE IF NOT EXISTS id7841828_phonebill.CUSTOMER_PHONE_NUMBERS (
...
CREATE TABLE IF NOT EXISTS id7841828_phonebill.BILL_HEADERS (
...
CREATE TABLE IF NOT EXISTS id7841828_phonebill.CUSTOMER_PHONE_CALLS (
...
CREATE TABLE id7841828_phonebill.BILL_DETAIL_LINES (
...
CREATE TABLE IF NOT EXISTS id7841828_phonebill.CUSTOMER_ADDRESSES (
